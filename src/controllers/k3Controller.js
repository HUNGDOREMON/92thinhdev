...
async function funHanding(game) {
    ...
    for (let i = 0; i < totalN; i++) {
        ...
        let check3 = false;
        let check4 = false;
        if (lengWin.length >= 1 && total >= 3 && total <= 10 && sult.includes('s')) {
            check1 = true;
        } else {
            check1 = false;
        }
        if (lengWin.length >= 1 && total >= 11 && total <= 18 && sult.includes('b')) {
            check2 = true;
        } else {
            check2 = false;
        }
        if (lengWin.length >= 1 && total % 2 == 0 && sult.includes('c')) {
            check3 = true;
        } else {
            check3 = false;
        }
        if (lengWin.length >= 1 && total % 2 != 0 && sult.includes('l')) {
            check4 = true;
        } else {
            check4 = false;
        }

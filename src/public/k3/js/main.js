    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                ...
                socket.emit('data-server-3', { chane, gameJoin: 1, listJoin, money, xvalue, game: $('html').attr('data-dpr') });
            }
            dropDown();
        }
    });
...
function sendGame2() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                $('.moneyU').text(response.money + '.00 ₫');
                socket.emit('data-server-3', { chane, gameJoin: 2, listJoin, money, xvalue, game: $('html').attr('data-dpr') });
            }
            dropDown();
        }
    });
...
function sendGame3() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                $('.moneyU').text(response.money + '.00 ₫');
                socket.emit('data-server-3', { chane, gameJoin: 3, listJoin, money, xvalue, game: $('html').attr('data-dpr') });
            }
            dropDown();
        }
    });
...
function sendGame4() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                $('.moneyU').text(response.money + '.00 ₫');
                socket.emit('data-server-3', { chane, gameJoin: 4, listJoin, money, xvalue, game: $('html').attr('data-dpr') });
            }
            dropDown();
        }
    });

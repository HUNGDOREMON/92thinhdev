...
const initWebRouter = (app) => {
  ...
  //get transfer coin
  router.get("/transferCoin", middlewareController, homeController.transferCoin);
  //post transfer coin
  router.post(
    "/api/webapi/transfer",
    middlewareController,
    userController.transferCoin
  );
  router.get(
    "/api/webapi/getCoinApi",
    middlewareController,
    userController.getCoinApi
  );
  router.get(
    "/api/webapi/myTeam",
    middlewareController,
  ...
  // Dẫn vào game
  router.get(
    "/api/webapi/listGame/:type/:game",
    middlewareController,
    userController.listGame
  );
